create table accounting ( id bigint not null auto_increment, primary key (id), benef_quotidien decimal(38,2), marge_quotidien float(53) not null, roas_quotidien float(53) not null, benef_total_avant_impot decimal(38,2), marge_avant_impot float(53) not null,   roas_total float(53) not null, chiffre_daffaire decimal(38,2),  duaurssaf decimal(38,2), benef_total_apres_impot decimal(38,2), marge_total_apres_impot float(53) not null, total_expenses decimal(38,2), total_revenues decimal(38,2), created_at datetime(6), updated_at datetime(6), is_refund bit) engine=InnoDB;
